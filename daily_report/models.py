...
class Article(models.Model):
    ...
    start = models.TimeField('始業時間',blank=True, null=True,max_length=10)	
    end = models.TimeField('終業時間',blank=True, null=True,max_length=10)
    ...
    created_at = models.DateTimeField(verbose_name="作成日時",default=timezone.now, blank=True, null=True, max_length=255)
